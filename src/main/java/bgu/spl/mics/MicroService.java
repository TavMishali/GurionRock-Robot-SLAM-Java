...
public abstract class MicroService implements Runnable {
    ...
    private List<Class<?>> messages = new CopyOnWriteArrayList<>();
    ...
    public final void run() {
        try {
            ...
            while (!terminated) {
                ...
                Callback<?> thisCall = callbackMap.get(message.getClass());
                ((Callback<Message>) thisCall).call(message);
            }
